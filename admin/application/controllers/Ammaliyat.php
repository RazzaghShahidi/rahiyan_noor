...
class Ammaliyat extends RN_Controller
{
    ...
    function add_ammaliyat()
    {
        ...
        if ($_POST) { //form sent
            ...
            $this->form_validation->set_rules('ammaliyat_start_date', 'تاریخ شروع', 'trim|xss_clean');
            $this->form_validation->set_rules('ammaliyat_end_date', 'تاریخ پایان عملیات', 'trim|xss_clean');
